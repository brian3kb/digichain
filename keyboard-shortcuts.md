...
**Shift + Click / Shift + Key**
 ...
 - Move Down Icon : moves directly to the end of the sample list.
...
**Ctrl + Shift + Click**
 ...
 - Move Up Icon : moves directly to the top of the current sample list page.
 - Move Down Icon : moves directly to the end of the current sample list page.
